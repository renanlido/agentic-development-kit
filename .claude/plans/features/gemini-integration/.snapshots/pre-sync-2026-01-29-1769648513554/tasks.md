...
- **Acceptance Criteria**:
  - [ ] AIProviderName type exported
  - [ ] ModelTier type exported
  - [ ] AIProviderModel interface exported
  - [ ] AIProviderOptions interface exported
  - [ ] AIProviderResult interface exported
  - [ ] AIProvider interface exported
  - [ ] AIProviderConfig interface exported
  - [ ] Type guards working
  - [ ] Re-export in `src/types/ai-provider.ts`
...
- **Acceptance Criteria**:
  - [ ] NormalizedEventType union exported
  - [ ] NormalizedStreamEvent interface exported
  - [ ] StreamParser interface exported
  - [ ] Type guards for event types
  - [ ] Compatible with CollectedMetrics
