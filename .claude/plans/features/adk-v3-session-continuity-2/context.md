# adk-v3-session-continuity-2 Context

Inherits: .claude/memory/project-context.md

## Feature-specific Context

Implementar Sprint 2. REGRA CRÍTICA: NÃO modificar src/cli.ts nem src/commands/feature.ts - criar arquivos NOVOS com sufixo -v3. NÃO fazer npm link. Testar com 'npm run adk3'. Ler os 4 documentos da pasta de contexto ANES de começar.
